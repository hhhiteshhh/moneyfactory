...
const MyQuantCard = ({data, navigation}) => {
  ...
  return (
    <View style={[tw('rounded-md p-3 my-2 relative'), styles.container]}>
      ...
      <Modal
        ...
        <LinearGradient
          ...
          style={{borderRadius: 6, height: windowHeight * 0.5}}
