...
const VirtualInvestor = ({navigation}) => {
    ...
    <View style={[tw('h-full px-5 relative'), styles.container]}>
      ...
      <ScrollView
        ...
        <Text
          ...
          Become an investing pro before you even put in a single rupee with our
          Virtual Investor mode.
        </Text>
        ...
        <Text
          ...
          How much would you like to invest based on your goals, risk appetite,
        ...
        <Text
          ...
          Choose a stock from the quant and deploy your a set virtual amount you
          would like to invest in it.
        </Text>
