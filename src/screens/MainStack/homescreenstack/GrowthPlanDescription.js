...
const GrowthPlanDescription = ({navigation}) => {
    ...
    <View style={[tw('h-full px-5 relative'), styles.container]}>
      ...
      <ScrollView
        ...
        <Text
          ...
          {'\n'}
          Put your money in high-performing quants and safely switch from one to
          the other with the least possible risk.
        </Text>
        ...
        <Text
          ...
          Let MoneyFactory send you regular updates on when to buy and sell your
          stocks.
        </Text>
