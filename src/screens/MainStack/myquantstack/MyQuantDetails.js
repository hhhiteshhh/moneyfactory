...
const MyQuantDetails = ({navigation, route}) => {
    ...
    <View style={[tw('h-full'), styles.container]}>
      ...
      <ScrollView
        ...
        {data?.stocksignals?.map((item, index) => (
          <View style={[tw('p-5 my-2'), styles.stockCard]}>
            <TouchableOpacity
              onPress={() => {
            ...
            {open.indexOf(index) !== -1 && (
              <>
                ...
                <View
                  ...
                  <View style={tw('flex items-start justify-start')}>
                    <View style={[tw(''), {}]}>
                      <Text style={[tw('py-2'), styles.iconText3]}>Price</Text>
                  ...
                  <View style={tw('flex items-start justify-start')}>
                    ...
                    <View style={[tw(''), {}]}>
                      ...
                      <Text
                        ...
                        {formatter.format(Number(item?.pldata?.pl).toFixed(2))}
                      </Text>
                    </View>
                  </View>
                </View>
